...
class DetailedItemController {
  ...
  try {
    ...
    itemData['departments'] = itemData.containsKey('departments') ? itemData['departments'] : [];
    itemData['paymentPlan'] = itemData.containsKey('paymentPlan') ? itemData['paymentPlan'] : null;
    ...
    if (ownerSnapshot.exists) {
      ...
      itemData['ownerProfilePicture'] = ownerSnapshot.data()!['profilePicture'];
    } else {
