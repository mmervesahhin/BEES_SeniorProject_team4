...
class LoginController {
  ...
  Future<void> handleLogin({
    ...
    bool rememberMe = false, // Added parameter for remember me functionality
  }) async {
    if (formKey.currentState?.validate() == true) {
      try {
        ...
        if (rememberMe) {
          // User wants to be remembered - use LOCAL persistence
          await _auth.setPersistence(Persistence.LOCAL);
        } else {
          // User doesn't want to be remembered - use SESSION persistence
        ...
        if (userCredential.user != null) {
          // Save remember me status and email if needed
