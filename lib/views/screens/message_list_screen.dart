...
class _MessageListScreenState extends State<MessageListScreen> {
  static final auth_user.User currentUser =
      auth_user.FirebaseAuth.instance.currentUser!;
          ...
          return FutureBuilder<String>(
            ...
            builder: (context, statusSnapshot) {
              ...
              return StreamBuilder<int>(
                stream: MessageController().getSentMessagesCount(
                    chatRoomId, currentUser.uid, otherUserId),
                builder: (context, messageCountSnapshot) {
                  ...
                  isRead =
                      messageCount == 0; // Update isRead based on message count
                        ...
                        onTap: isActive
                            ? () async {
                                if (entityType == "Item") {
                                  ...
                                  Item itemEntity =
                                      Item.fromJson(entity, itemId);
                                  await _navigateToMessageScreen(chatRoomId,
                                      itemEntity, entityType, context);
                                  setState(() {
  ...
  Future<void> _navigateToMessageScreen(String chatRoomId, dynamic entity,
      String entityType, BuildContext context) async {
    ...
    try {
      ...
      if (otherUserDoc.exists) {
        bool isBanned = otherUserDoc.get('isBanned') ?? false;
            ...
            child: _isLoading
                ...
                : StreamBuilder<List<ChatRoom>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      sortedChatRooms.sort((a, b) => b.lastMessageTimestamp
