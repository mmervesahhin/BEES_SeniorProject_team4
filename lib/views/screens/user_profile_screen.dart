            ...
            onPressed: () async {
              if (formKey.currentState?.validate() ?? false) {
                try {
                  ...
                  if (success) {
                    _showSnackBar('Request updated successfully', isSuccess: true);
                  } else {
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: item.itemStatus == 'active' ? primaryYellow : Colors.grey,
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(
                        item.itemStatus == 'active' ? Icons.check_circle : Icons.hourglass_empty,
                        color: Colors.white,
                        size: 14,
                      ),
                      SizedBox(width: 4),
                      Text(
                        item.itemStatus == 'active' ? 'Active' : item.itemStatus,
                        style: GoogleFonts.nunito(
                          color: Colors.white,
                          fontWeight: FontWeight.bold,
                          fontSize: 12,
  ...
  Future<void> _showDeleteConfirmation(BuildContext context, Item item) async {
    ...
    if (confirmed == true) {
      try {
        ...
        if (success) {
          setState(() {});
          _showSnackBar('Item marked as inactive successfully', isSuccess: true);
        } else {
  ...
  Future<void> _markRequestAsSolved(Request request) async {
    ...
    if (confirmed == true) {
      try {
        ...
        if (success) {
          _showSnackBar('Request marked as solved successfully', isSuccess: true);
        } else {
      ...
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: [
              SizedBox(height: 24),
        _buildProfileStats(user), // Replace your old stats row with this
        SizedBox(height: 24),
            ],
          ),
        ),
...
Widget _buildProfileStats(User user) {
  ...
  return Scaffold(
    ...
    bottomNavigationBar: BottomNavigationBar(
      ...
      selectedLabelStyle: GoogleFonts.nunito(fontWeight: FontWeight.w600, fontSize: 12),
